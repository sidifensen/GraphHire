  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-sans bg-surface-background p-4 relative overflow-x-hidden antialiased">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute bottom-[-10%] left-[-5%] w-[50%] h-[50%] bg-secondary/5 rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="px-8 pb-8">
            <form onSubmit={handleRegister} className="space-y-6">
                  ...
                  >
                    <div className="pt-3 pb-1">
                      <div className="space-y-4 bg-surface-low p-4 rounded-2xl border border-outline-variant/30 relative text-on-surface">
                        <div className="absolute top-0 left-4 -translate-y-1/2 bg-surface-lowest px-2 text-[10px] font-black text-primary tracking-widest uppercase border border-outline-variant/20 rounded font-sans">企业认证信息</div>
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input className="w-full pl-10 pr-4 py-2.5 bg-surface-lowest border border-outline-variant rounded-lg text-sm text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all" id="companyName" placeholder="请输入企业全称" type="text" />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input className="w-full pl-10 pr-4 py-2.5 bg-surface-lowest border border-outline-variant rounded-lg text-sm text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all" id="creditCode" placeholder="18位验证码或数字" type="text" />
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input className="w-full pl-10 pr-4 py-2.5 bg-surface-lowest border border-outline-variant rounded-lg text-sm text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all" id="phone" placeholder="请输入手机号" type="tel" />
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex gap-3">
                    <div className="relative flex-1">
                      ...
                      <input className="w-full pl-10 pr-4 py-2.5 bg-surface-lowest border border-outline-variant rounded-lg text-sm text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all" id="verificationCode" placeholder="6位验证码" type="text" />
                    </div>
                    <button className="whitespace-nowrap px-4 py-2.5 bg-surface-low border border-outline-variant text-primary font-bold text-xs rounded-lg hover:bg-surface-variant transition-colors" type="button">
                      获取验证码
                    </button>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-outline" size={18} />
                      <input className="w-full pl-10 pr-4 py-2.5 bg-surface-lowest border border-outline-variant rounded-lg text-sm text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all" id="password" placeholder="至少8位字符" type="password" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      <Lock className="absolute left-3 top-1/2 -translate-y-1/2 text-outline" size={18} />
                      <input className="w-full pl-10 pr-4 py-2.5 bg-surface-lowest border border-outline-variant rounded-lg text-sm text-on-surface focus:border-primary focus:ring-2 focus:ring-primary/10 outline-none transition-all" id="confirmPassword" placeholder="再次输入密码" type="password" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2">
                <input className="w-4 h-4 text-primary bg-surface-lowest border-outline-variant rounded focus:ring-primary cursor-pointer mt-0.5" id="agreement" type="checkbox" required />
