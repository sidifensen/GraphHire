...
import { MOCK_COMPANIES, MOCK_JOBS } from '@/app/(user)/_mock/mockData';
          ...
          <div className="lg:col-span-1">
            <section className="sticky top-24 space-y-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/jobs" className="text-primary text-sm font-black flex items-center gap-1 hover:gap-2 transition-all">
