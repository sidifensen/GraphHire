...
import { mockNotifications } from "@/app/enterprise/_mock/lib/mockData";
...
export default function Messages() {
  ...
  return (
    <div className="bg-background min-h-screen text-on-surface antialiased flex flex-col h-full items-center">
      ...
      <div className="w-full max-w-[375px] md:max-w-3xl mx-auto px-container-margin pt-stack-gap-md pb-stack-gap-xs z-30 bg-background/95 backdrop-blur-md sticky top-0 border-b border-surface-variant">
      ...
      {/* Notification List */}
      <main className="w-full max-w-[375px] md:max-w-3xl mx-auto flex-1 px-container-margin py-stack-gap-md flex flex-col gap-stack-gap-sm overflow-y-auto pb-safe">
