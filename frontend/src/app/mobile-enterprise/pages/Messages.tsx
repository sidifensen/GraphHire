...
export default function Messages() {
  ...
  return (
    <div className="bg-background min-h-screen text-on-surface antialiased flex flex-col h-full items-center">
      ...
      <div className="w-full max-w-[375px] md:max-w-2xl mx-auto px-container-margin pt-stack-gap-md pb-stack-gap-xs z-30 bg-surface backdrop-blur-md sticky top-16 border-b border-surface-variant">
