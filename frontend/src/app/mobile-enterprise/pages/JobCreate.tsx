...
export default function JobCreate() {
  ...
  return (
    <div className="flex flex-col h-full bg-surface-container-highest relative pb-[80px]">
      ...
      <main className="w-full bg-background flex-1 flex flex-col shadow-lg overflow-y-auto py-stack-gap-md pb-32 gap-stack-gap-lg">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-surface backdrop-blur-sm border-t border-surface-variant py-4 pb-safe shadow-[0_-4px_16px_rgba(0,0,0,0.02)] z-20">
        <button 
