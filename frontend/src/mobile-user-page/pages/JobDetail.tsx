...
import { useParams, Link } from '@/mobile-user-page/router';
  ...
  return (
    <div className="flex flex-col min-h-screen pb-safe">
      ...
      <main className="px-5 pt-6 pb-24">
        ...
        <section className="mb-8">
          <Link 
            to="/companies/bytedance"
            className="flex items-center gap-4 p-4 bg-white rounded-2xl shadow-sm border border-surface-mid active:scale-[0.98] transition-transform"
          >
            <img src={job.companyLogo} className="w-14 h-14 rounded-xl border border-surface-mid object-contain p-1" alt="logo" />
            <div className="flex-1 overflow-hidden">
              <h3 className="font-bold text-on-surface truncate">星辰未来科技有限公司</h3>
              <p className="text-xs text-on-surface-variant truncate">D轮及以上 · 1000-9999人 · 人工智能</p>
            </div>
        ...
        <section className="space-y-8">
          <div>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-bold text-sm mb-2">岗位职责：</h4>
                <ul className="text-body-md text-on-surface-variant leading-relaxed space-y-2 list-disc pl-5">
                  <li>负责大规模语言模型（LLM）的微调与优化，提升在特定垂直领域的表现。</li>
                  <li>设计并实现高效的推荐算法架构，解决海量数据下的高并发推荐问题。</li>
                  <li>跟进业内最新的AI技术动态，将前沿研究成果转化为实际产品落地。</li>
                </ul>
              </div>
              <div>
                <h4 className="font-bold text-sm mb-2">任职要求：</h4>
                <ul className="text-body-md text-on-surface-variant leading-relaxed space-y-2 list-disc pl-5">
                  <li>计算机、数学或相关专业硕士及以上学历，具有扎实的机器学习基础。</li>
                  <li>熟练掌握Python/C++，熟悉PyTorch、TensorFlow。</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div className="fixed bottom-0 left-0 w-full max-w-md left-1/2 -translate-x-1/2 bg-white flex gap-4 p-5 border-t border-surface-mid pb-safe z-50">
