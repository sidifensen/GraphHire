    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="w-full">
        ...
        <section className="relative w-full min-h-[600px] flex flex-col justify-center items-start px-5 md:px-xl overflow-hidden bg-white h-auto py-24">
          ...
          <div className="relative z-10 max-w-2xl px-margin-mobile">
            <motion.div 
            ...
            <motion.h1 
              ...
              className="text-4xl font-black text-on-surface mb-6 leading-tight tracking-tight"
            >
              连接卓越，<br/>
            ...
            <motion.p 
              ...
              className="text-lg text-on-surface-variant mb-10 max-w-md leading-relaxed font-medium"
            >
        ...
        <section className="py-12 px-5 bg-surface-background">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto px-margin-mobile">
            <div className="rounded-[32px] overflow-hidden shadow-lg bg-white aspect-[4/3] md:aspect-auto relative group">
              <img 
        ...
        <section className="py-20 px-5 bg-white relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10 px-margin-mobile">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-black text-on-surface mb-4">核心能力矩阵</h2>
              <p className="text-base text-on-surface-variant max-w-lg mx-auto leading-relaxed">以技术赋能招聘全链路，打造高效、精准、安全的人才供应链。</p>
            </div>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {/* Feature 1 */}
              <div className="relative p-10 rounded-[32px] bg-white border border-surface-mid shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">
        ...
        <section className="py-20 px-5 bg-surface-background border-y border-surface-mid">
          <div className="max-w-6xl mx-auto px-margin-mobile">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="flex flex-col items-center justify-center p-6 bg-white rounded-3xl shadow-sm border border-white">
        ...
        >
          ...
          >
            ...
            <Link 
              to="/jobs" 
              className="inline-block px-12 py-5 bg-white text-primary font-black text-xl rounded-2xl shadow-2xl hover:scale-105 hover:bg-surface-low transition-all"
            >
              立即开启智能招聘
            </Link>
          </motion.div>
