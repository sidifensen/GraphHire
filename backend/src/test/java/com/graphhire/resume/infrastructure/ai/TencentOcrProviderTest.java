...
class TencentOcrProviderTest {

    @Test
    void shouldReturnFailureWhenSecretMissing() {
        OcrProperties properties = new OcrProperties();
        properties.getTencent().setSecretId("");
        properties.getTencent().setSecretKey("secret");

        TencentOcrProvider provider = new TencentOcrProvider(properties);
